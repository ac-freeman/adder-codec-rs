...
//     /// ```
//     fn new(&self, num_rows: usize, num_cols: usize, num_channels: usize) -> Array3D<Option<T>> {
...
//     /// let arr: Array3D<Event> = Array3D::new(10, 10, 3);
//     /// ```
//     fn new_init(&self, value: T, num_rows: usize, num_cols: usize, num_channels: usize) -> Array3D<Option<T>> {
...
//     }
//
//     fn new_like(&self, ref_array: &Array3D<T>) -> Array3D<Option<T>> {
...
//     }
//
//     fn at(&self, row: usize, col: usize, channel: usize) -> Result<&T, Array3DError> {
...
//     /// *elem = 255;
//     /// ```
//     fn at_mut(&mut self, row: usize, col: usize, channel: usize) -> Option<&mut T> {
//         match self.check_idx(row, col, channel) {
//             Ok(_) => {
...
//     /// *elem = 10;
//     /// ```
//     fn set_at(&mut self, item: T, row: usize, col: usize, channel: usize) -> Result<&mut T, Array3DError>{
//         match self.check_idx(row, col, channel) {
//             Ok(_) => {
...
//     /// }
//     /// ```
//     fn iter_2d(&self) -> IntoChunks<Iter<'_, T>> {
...
//     ///     break;
//     /// }
//     fn iter_2d_mut(&mut self) -> IntoChunks<IterMut<'_, T>> {
...
// impl<T: std::clone::Clone + Default + FrameValue<Output = T>> Array3<Option<T>> where T: num::Unsigned{
//     pub fn serialize_to_be_bytes(&self) ->  BytesMut {
//         // todo!();
//         let mut buf = BytesMut::with_capacity(self.num_rows*self.num_cols*self.num_channels * size_of::<T>());
//         for elem in &self.iter_2d() {
...
//                     }
//                     None => {
//                         buf.put(Bytes::from((0 as T).to_be_bytes().to_vec()));
//                     }
//                 }
//             }
//         }
...
// }
//
// impl Array3<Option<EventCoordless>> {
//     pub fn serialize_to_be_bytes(&self) ->  BytesMut {
//         todo!();
//         let mut buf = BytesMut::with_capacity(self.num_rows*self.num_cols*self.num_channels * size_of::<EventCoordless>());
//         for elem in &self.iter_2d() {
...
//
//
// impl<T: Default + std::clone::Clone > Index<(usize, usize)> for Array3<T> where bytes::Bytes: From<T> {
//     type Output = T;
//
