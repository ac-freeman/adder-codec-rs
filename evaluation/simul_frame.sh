...
for (( i = 0; i <= 20; i += 2 ))
do 
    cargo run --release --bin transcode_and_frame_simultaneous -- --show-display 0 --scale 1.0 --input-filename "/home/andrew/Downloads/lake_scaled_hd.mp4" --output-raw-video-filename "/home/andrew/Downloads/lake/out_${i}" --c-thresh-pos $i --c-thresh-neg $i
